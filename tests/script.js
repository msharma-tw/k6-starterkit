...
export let options = {
    scenarios: {
        ...
        my_api_test_1: {
            ...
            maxVUs: 20, // we don't want to allocate more VUs mid-test in this scenario
        ...
        my_api_test_2: {
            ...
            stages: [
                { target: 200, duration: '1m' }, // go from 50 to 200 iters/s in the first 30 seconds
                { target: 200, duration: '2m' }, // hold at 200 iters/s for 3.5 minutes
